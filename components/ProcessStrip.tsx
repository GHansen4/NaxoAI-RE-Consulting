...
// Icons removed - keeping only numbered badges
    ...
    <section className="py-12 lg:py-16 bg-slate-50">
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 relative">
          ...
          <div className="hidden md:block absolute top-8 left-1/3 right-1/3 h-0.5 bg-primary-100 z-0"></div>
          ...
          {processSteps.map((step, index) => (
            <AnimatedSection key={index} delay={index * 100 + 200}>
              <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5 sm:p-6 text-center hover:shadow-md transition-shadow duration-200 relative z-10">
                {/* Step Number Badge */}
                <div className="h-8 w-8 rounded-full bg-primary-600 text-white text-sm font-medium flex items-center justify-center mx-auto mb-4">
                  {index + 1}
                </div>
